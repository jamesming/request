   ...
   public function __construct(){
	...
	public function test(){
		...
		?>
			...
			<img src='<?php echo base_url()    ?>index.php/home/thumb_of_youtube_video_id/TJAfLE39ZZ8/348'>
	...
	/**
	 * thumb_of_youtube_video_id
	 * 
	 * @package BackEnd
	 * @author James Ming <jamesming@gmail.com>
	 * @path /index.php/home/thumb_of_youtube_video_id
	 * @access public
	 */
	 
	public function thumb_of_youtube_video_id(){

		$thumb_image = $this->tools->show_thumbnail_of(
			$filename = $this->tools->get_thumbnail_from_youtube_video_id($this->uri->segment(3)), 
	...
	public function login(){
		...
		if( $this->input->post() ){
			...
			if( $validation['is'] == 'true'	){
					...
					if( $validation['welcomed'] == 1 ){
						redirect('/main/index/menu/dashboard');
					}else{
						redirect('/main/index/start/1');
					};
