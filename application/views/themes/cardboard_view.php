...
<div id='scaryframe'  class=' container' >
			<div  id='profile_text_container'   > 
				<div  id='home_text'  class='scroll-pane-arrows''   >
					<?php  echo $website_data['users'][0]->bio_text   ?>			
				</div>	
				<?php
...
?>
		...
		$('#social_icon_wrapper').css({position:'absolute','margin-top':'200px', padding:'30px 0px 0px 100px'})
		$('#form_wrapper').css({position:'absolute','margin-top':'280px', padding:'30px 0px 0px 100px'})
