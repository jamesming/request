...
<form id='uploadForm' 
	name='uploadForm' action='<?php echo  base_url();   ?>index.php/main/upload_picture' 
	method='post' 
	enctype='multipart/form-data'>	
	<div id='input_container'    >
			<div  class='first float_left' >
				<input id='select_file' type="file" name="Filedata" size="20"      />
				<input name="picture_id" id="picture_id" type="hidden" value="<?php echo $picture_id    ?>">
				<input name="menu_item" type="hidden" value="<?php echo $menu_item    ?>">
